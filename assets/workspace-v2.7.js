...
(() => {
  ...
  function init() {
    ...
    renderDrafts(); renderLibraries(); bindLibraries(); renderPrivacy(); updateContractPlaceholder();
    ...
    window.__ACTS_WORKSPACE_TEST_API__ = Object.freeze({ semanticErrors, importFields, parseRuDate, parseBackup, backupPayload, updateContractPlaceholder, selectLibrary, getState: () => structuredClone(state), getPreferences: () => structuredClone(prefs) });
  }
})();
